...
export default function SiteHeader() {
  ...
  return (
    <header className="site-header">
      <Link
        className="wordmark has-tooltip"
        href="/"
      ...
      <div className="social-links" aria-label="Social profiles">
        <a
          className="social-behance has-tooltip"
          href={profile.behance}
          target="_blank"
          rel="noreferrer"
          aria-label="Behance Profile"
          data-tooltip="Behance Profile"
          title="Behance Profile"
        >
          <BehanceIcon />
        </a>
        <a
          className="social-linkedin has-tooltip"
        ...
        <a
          className="social-github has-tooltip"
          href={profile.github}
          target="_blank"
          rel="noreferrer"
